...
const getUser = async () => {
  ...
  if (user) {
    ...
    userData.value.role = metadata.role || 'Traveler'
    ...
    >
      <div>
        ...
        <v-btn
          ...
          :color="isActive('/discoverfarm').value ? 'green-darken-1' : 'grey-lighten-4'"
          :variant="isActive('/discoverfarm').value ? 'elevated' : 'flat'"
        ...
        <v-btn
          ...
          :color="isActive('/visitfarm').value ? 'green-darken-1' : 'grey-lighten-4'"
          :variant="isActive('/visitfarm').value ? 'elevated' : 'flat'"
        ...
        <v-btn
          ...
          height="50"
          class="mb-4 rounded-xl"
          :color="isActive('/buylocalproducts').value ? 'green-darken-1' : 'grey-lighten-4'"
          :variant="isActive('/buylocalproducts').value ? 'elevated' : 'flat'"
        ...
        <v-btn
          ...
          height="50"
          class="mb-4 rounded-xl"
          :color="isActive('/traveleraccount').value ? 'green-darken-1' : 'grey-lighten-4'"
          :variant="isActive('/traveleraccount').value ? 'elevated' : 'flat'"
